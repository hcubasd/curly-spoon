...
CREATE TABLE sales.crm_organizations_industries (
    organization_id text NOT NULL REFERENCES sales.crm_organizations ON DELETE CASCADE,
    industry_id text NOT NULL REFERENCES sales.crm_industries ON DELETE CASCADE,
